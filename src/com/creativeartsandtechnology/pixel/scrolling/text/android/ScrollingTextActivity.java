...
package com.creativeartsandtechnology.pixel.scrolling.text.android;
...
public class ScrollingTextActivity extends IOIOActivity implements OnColorChangedListener 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
       ...
       // prefYoffset_ = prefs.getInt("prefYoffset", KIND.height/2); //default to in the middle
        ...
        prefScrollingText = savePrefs.getString("scrollingTextKey","TYPE TEXT HERE OR CHOOSE SETTINGS FOR TWITTER FEED");
